...
Before you begin the pasteurization process, I would recommend that you use a sieve to only allow small particulates of soil and compost to pass through. I would also recommend you add some sand to this mix, if easily available. Now, pasteurize this mix and then add an equal proportion of moistened coconut coir to prevent the soil from clumping up and forming a brick. The coconut coir will help keep the soil loose and aerated. You can buy coconut coir bricks from your local gardening or pet store.
                        ...
                        <br/>
                        <h3>HOW TO MAKE OWN SEED STARTER MIX</h3>
                        <p>
                        ...
                        <ol>
                            <li>Coconut coir (2 parts if dry, 8 parts if pre-moistened)</li>
                            <li>Vermiculite (1 part)</li>
                            <li>Perlite (1 part)</li>
                            <li>Screened worm castings to also serve as a potting mix (4 parts)</li>
                        </ol>
                        <br/>
                        ...
                        <br/>
                        <br/>
                        <h3>SOWING YOUR TOMATO SEEDS</h3>
                        <p>
                            <ul typeof="square">
                                <li>Once you've got your containers, seeds, and germinating soil ready, you're going to want to fill up your containers with the soil (to the brim).</li>
                                <li>Now make holes into the top of the soil, around a quarter of an inch deep using your finger, a stick, or a pencil.</li>
                                <li>Plant two to three seeds in every section/container by dropping seeds into the holes you've just made. When planting two or more seeds, make a hole for each seed, do not place two seeds at the exact same spot.</li>
                                <li>Finally, cover up the seeds with a pinch of new soil filling up the hole.</li>
                            </ul>
                        </p>
                        <br/>
                        <br/>
                        <h3>WATERING TOMATO SEEDS</h3>
                        <p>
                        It is best to dampen the soil before filling it into the containers, because the loose germinating soil settles down and gets compacted a bit on the addition of water. After you've placed your seeds you should water again, to moisten the seed. You could sprinkle a few drops of water on the top, ensuring the seed (below the soil) is dampened.
                        <br/>
                        ...
                        <h3>PROVIDING ADEQUATE LIGHT TO YOUR SEEDLING</h3>
                        <p>
                        Tomato plants require sufficient light to grow well. I have personally never had to use grow lights because I always lived in regions with at least 12 hours of warm sunlight on a south-facing windowsill. However, if you do not have the same luxury, it is beneficial if you provide your tomato seedlings with grow lights. My guide on tomato plant light requirements would help you decide if you need grow lights.
                        </p>
                        <h4></h4>
